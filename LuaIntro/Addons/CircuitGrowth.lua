...
local function DrawInfo()
	...
	Font:Print("Spring "..(Engine and (Engine.versionFull or Engine.version) or Game.version or "?")
		..(Engine and Engine.wordSize and " ("..Engine.wordSize.." bits)" or "")
		.." "..(Engine and Engine.buildFlags or Game.buildFlags or ""),7,vsy-7,16,"ao")
