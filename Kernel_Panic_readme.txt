...
-------------------
  ...
  * From installer (Kernel_Panic_4.9_Including_Spring_105.0_InstallerXX.exe) :
      ...
      > If you already know about Spring:
        ...
        Kernel Panic 4.9 requires Spring 105.0 for multiplayer,
        ...
        + If you have an up-to-date version of Spring
          ...
          - So you have to install KP in the same folder as your current Spring 105.0
            x No user file should be lost or modified
            x But feel free to untick the "engine" install so as to be more safe

        + If you have a version of Spring over 105.0:
      ...
      > Kernel Panic requires the Spring engine:
        ...
        + If you don't have Spring, or have a version lower than 0.78.2
          ...
          - If you are running Windows:
            x Download spring_105.0_win64_portable.7z, or higher, for multiplayer
            x Other version may be used for single player, in case 105.0 doesn't work for you
        ...
        + Once you have Spring 105.0
          - Unzip Kernel_Panic_4.9.zip into your Spring folder
  ...
  * From sd7 (Kernel_Panic_4.9.sd7) :
      ...
      > Kernel Panic is best played on custom Kernel Panic maps
        ...
        If you don't have those maps, I suggest getting Kernel_Panic_4.9.zip wich contains maps and mods, or to check:
  ...
  * To play:
      ...
      > To play single player, either:
        ...
        + Go to where Spring is installed and run Kernel_Panic_4.9_Launcher.exe
          ...
          For Kernel Panic 4.7 to 4.9, both external launcher and internal menu run copies of the same Lua code.
      ...
      > To play multiplayer player:
        ...
        + You must use a multiplayer lobby
          ...
          Note: The installer of Kernel Panic 3.1 to 3.6 used KPSClient which was a hacked up TASClient.
                From Kernel Panic 3.6 Spring 0.80 Installer 15 to Kernel Panic 4.7 Spring 103 Installer 37,
                instead I used the regular TASClient, customised via the commandline option -inifile.
                From Kernel Panic 4.7 Spring 104 Installer 38, it became incompatible. So using SpringLobby.
...
Installing Kernel Panic will add one entry to the list of available mods: Kernel Panic 4.9, which is the complete version, with all the units and all the special abilities. If you wish to play the old "Kernel Panic Evilless": tick the two corresponding modoptions in the "Mod options" tab of the battleroom.
...
KP 4.9
- Handle the swapping of 7th and 8th argument of Spring.GetTeamInfo
- Added main.lua into LuaUI to make widgets work again
- Set CanMove=1; in socket.fbi so that they can be given exit waypoint
- Fixed buildpic file extension in counter.fbi

KP 4.8
- Fix gadgets, widgets, addons crashing because Game.version got moved to Engine.version in Spring 104
